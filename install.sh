...
echo "     source ~/.zshrc"
echo ""
echo "  2. Run 'exec zsh' to switch to the new shell (keyboard bindings included)"
echo "  3. Run 'claude' to authenticate Claude Code"
echo "  4. Run 'codex login --device-auth' to authenticate Codex"
echo "  5. Run 'gemini' to authenticate Gemini"
echo ""
echo "Quick commands:"
